...
outputdir="${workDir}/output-$REF"
splitdir="${workDir}/split-$REF"
tmpdir="${workDir}/tmp-$REF"
...
cat ${outputdir}/merged_sort.txt | parallel --pipe awk -f ${scriptDir}/scripts/dups.awk -v name=${outputdir}/ ##${outputdir}/merged_sort.txt
